...
system_prompt_template_v0 = """You are a writer who has picked up a board topic for which you want to write a detailed yet interesting and capitvating blog post. You will be given the broad topic, you need to give 5 unique ideas for the blog post and label the genre for the topic.
